     ...
     <div class="collapse" id="collapseComment<?php echo $allfeed["id"] ?>">
        <form method="post" class="form-inline" action="comment.php" role="comment">
            ...
            <div class="form-group">
                <input type="text" name="write_comment" class="form-control come_form" style="width:400px;border-radius: 100px!important; -webkit-appearance:none;" placeholder="コメントを書く">
            </div>
